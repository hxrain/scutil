...
class dfa_match_t():
    ...
    def do_match(self, message, msg_len=None, isall=True):
        ...
        while offset < msg_len:
            rc = self.do_check(message, msg_len, offset)
    ...
    def do_check(self, message, msg_len=None, offset=0):
