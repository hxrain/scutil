...
nt_tails = {
    # 工矿企业
    '分店': {'.': {types.NB}, '-': {},
           '+': {'分号', '分厂', '分矿', '分校', '分团', '分公司', '子公司', '分工厂', '分司', '分工司', '支公司', '分部', '分局', '分院', '分所', '直属分局', '支局', '分园', '子厂', '分场', '分社',
    ...
    '教会': {'.': {types.NM, types.relig}, '-': {},
           '+': {'天主堂', '教堂', '天主教下会点', '天主教公所', '天主教堂', '天主教活动场所', '基督教活动场所', '基督教活动固定场所', '基督教场所', '天主教祈祷所', '天主教爱国会',
                 '基督教三自爱国会', '基督教青年会', '教区', }},
    # 洗浴会所
    ...
    '连锁': {'.': {types.NM, types.retail}, '-': {'连锁经营'},
           '+': {'农资连锁', '服务连锁', '母婴连锁', '连锁店', '连锁商亭', '连锁经销部', '连锁配送部', '连锁经营部', '连锁销售点', '连锁机构'}},
    ...
    '与': {'.': {types.NA}, '-': {},
          '+': {'华北', '东北', '华东', '华中', '华南', '西南', '西北', '东部', '中部', '西部', '中南', '北方', '南方', '东南', '南部', '北部', '以东', '以西', '以南', '以北',
                '大街', '大道', '东', '南', '西', '北', '省', '市', '区', '县', '州', '盟', '旗', '乡', '村', '镇', '屯', '组', '路', '街', '巷', '河', '道', '线', '段', '跨', '左', '右', '等', '总',
                '新', '旧', '老', '原', '含', '驻', '办', '居', '女', '至', '暨', '和', '及', '内', '外', '上', '下', '小', '案', '报', '旁', '的', '/', '·', '.', '-', '、', '&',
                'A', 'B', 'C', 'D', 'E',
                }},
    ...
    '片区': {'.': {types.NS4, types.service}, '-': {},
           '+': {'园区', '分区', '中心片', '疗区', '监区', '林区', '矿区', '厂区', '坝区', '煤区', '分灌区', '新片区', '示范片', '林场区', '居民区', '小区', '住宅区', '分蓄洪区', '蓄洪区', '洪泛区',
                 ...
                 '职业教育园区', '农副产品加工交易园区', '汽车园区', '低碳经济园区', '创业园区',
                 }},
    '社区': {'.': {types.NS5, types.gov}, '-': {},
           '+': {'街道', '集体资产社区', '组团虚拟社区', '直属社区', '直属虚拟社区', '虚拟社区', '虚拟生活区', '生活区', '类似社区', '联合小区', '产业社区', '工业社区', '类似乡级单位', '特殊社区',
                 ...
                 '火车站社区', '花园', '农场社区', '总场社区', '林场社区', '工业园小区', '辖区', }},
    # 院校/加油站的南北区
    '办公区': {'.': {types.NS6, types.area}, '-': {},
            '+': {'东区', '南区', '西区', '北区', '中区'}},
    ...
    '(普通合伙)': {'.': {types.NL, types.financial}, '-': {},
               '+': {'(特殊合伙)', '(有限合伙)', '(特殊普通合伙)', '(有限合伙企业)', '(普通合伙企业)', '(特殊普通合伙企业)', '(普通合伙分支机构)'}},
    '(有限公司)': {'.': {types.NL, types.com}, '-': {},
               '+': {'(有限责任)', '(有限责任公司)', '(股份有限公司)', '(公司)', }},
    '(微型企业)': {'.': {types.NL, types.service}, '-': {},
               '+': {'(个体工商户)', '(无字号名称)', '(个人独资)', '(个人独资企业)'}},
