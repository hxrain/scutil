...
nt_tails = {
    ...
    '工厂': {'.': {types.NM, types.industry}, '-': {},
           '+': {'加工厂', '化工厂', '学区', '工区', '件厂', '剂厂', '布厂', '床厂', '总厂', '机厂', '材厂', '板厂', '水厂', '油厂', '泵厂', '工廠', '净水厂', '纯水厂', '纯净水厂',
                 ...
                 "香厂", "实验厂", '选煤厂', '车间', '采油厂', '盐厂', '窗纱厂', '火柴厂', '制作厂', '工加厂'}},
    ...
    '地区': {'.': {types.NS3}, '-': {},
           '+': {'新建区', '新区', '托管区', '保护区', '经开区', '管区', '保护开发区', '保税区', '边境经济合作区', '产业集聚区',
                 ...
                 '生态经济开发区', '示范区', '特别合作区', '特区', '特色农业经济开发区', '外商投资工业区', '高技术产业开发区', '外向型农业开发区',
    ...
    '景区': {'.': {types.NS3, types.NM, types.cultural}, '-': {},
           '+': {'风景旅游区', '风景名胜区', '风景区', '风景游览区', '名胜风景区', '旅游度假区', '旅游渡假区', '旅游管理区', '旅游经济开发区', '旅游景区', '旅游开发区', '旅游区', '温泉风景区', '温泉疗养旅游开发区',
                 ...
                 '商业文化旅游中心区', '生态文化旅游示范区', '文化景区', '生态文化旅游区', '风景名胜管理区'}},
    '园区': {'.': {types.NS4, types.NM, types.service, types.industry}, '-': {},
           '+': {'采区', '产业园区', '城市工业园区', '发展园区', '服务区', '高教园区', '高科技园区', '高科园区', '高新技术产业园区', '高新技术示范园区', '工业园区', '工业园小区', '广场',
                 '国家农业园区', '化工园区', '教区', '教育园区', '经济工业园区', '酒业园区', '科工贸园区', '科技园区', '空港物流园区', '临港化工园区', '临港物流园区', '牧业园区', '农业高新技术园区',
                 '农业科技园区', '农业园区', '汽车园区', '商务产业园区', '深加工园区', '生态工业园区', '示范小区', '停车区', '微电子小区', '温泉休闲商务产业园区', '物流园区', '物业区', '现代农业园区',
