...
nt_tails = {
    ...
    '工厂': {'.': {types.NM, types.industry}, '-': {},
           '+': {'加工厂', '化工厂', '学区', '工区', '件厂', '剂厂', '布厂', '床厂', '总厂', '机厂', '材厂', '板厂', '水厂', '油厂', '泵厂', '工廠',
    ...
    '地区': {'.': {types.NS3}, '-': {},
           '+': {'新建区', '新区', '托管区', '保护区', '经开区', '资源区', '管护区', '管理区', '管区', '灌区', '垦区', '围垦区', '库区', '林区', '保护开发区', '保税港区', '保税区', '边境经济合作区', '产业集聚区', '产业经济开发区', '产业聚集区',
                 '多功能配套区', '纺织工业聚集区', '食品工业聚集区', '改革示范区', '高技区', '高新技术产业开发区', '高新开发区', '高新区', '高新实用技术开发区', '产业示范区', '出口加工区', '创新示范区', '生态工贸区',
                 '工矿区', '工贸区', '工业发展区', '工业集聚区', '工业集中区', '工业聚集区', '工业开发区', '工业区', '工业转型试验区', '工业综合开发区', '公安管区', '沿海经济区', '临港产业区', '综合试验核心区',
                 '国际合作示范区', '国际物流加工区', '国际物流区', '国家高新区', '国家自主创新示范区', '海港经济开发区', '海洋经济开发区', '航空港区', '航空物流区', '工业加工区', '高新技术产业示范区',
                 ...
                 '生态经济开发区', '示范区', '水库灌区', '特别管理区', '特别行政管理区', '特别合作区', '特区', '特色农业经济开发区', '外商投资工业区', '外向型工业加工区', '高技术产业开发区', '外向型农业开发区',
                 ...
                 '综合开发区', '综合实验区', '作业区', '城乡一体化示范区', '农业高新技术产业示范区', '现代畜牧业示范区', '畜牧业示范区', '工业转型集聚区', '中央商务区', '新兴工业集中区', '环城工业集中区',
    ...
    '园区': {'.': {types.NS4, types.service, types.industry}, '-': {},
    ...
    '社区': {'.': {types.NS5, types.service, types.industry}, '-': {},
    ...
    '馆': {'.': {types.NO, types.service}, '-': {'馆长', '馆藏', '本馆', '我馆'}, '+': {}},
