...
nt_tails = {
    ...
    '分店': {'.': types.tags_NB, '-': {},
           '+': {'分号', '分厂', '分矿', '分校', '分团', '分公司', '子公司', '分工厂', '分司', '分工司', '支公司', '分部', '经营分部', '分局', '分院', '分所', '直属分局', '支局', '分园', '子厂', '分场',
                 '分社', '工会分会', '分会所', '分站', "分会", "子站", "分队", "分处", '分台', '(分)局', '名胜区分公司', '新机场分公司', '机场分公司', '林场分公司', '牧场分公司', '农牧场分公司', '畜牧场分公司',
                 '火车站分公司', '火车站分社', '分馆', '分工场', '分药店', '分诊所', '分病区', '分门诊', '中心分社', '中心支局', '中心支公司', '支校', '分校园', '分(院)', '分市场', '小分队', '分校区',
                 '支中心', '分中心', '有限分公司', '酒店分公司', '大酒店分公司', '分院区', '分药房', '分苗圃', '分车库', '大队'}},
    ...
    '公司': {'.': types.tags_NM, '-': {},
           '+': {'总公司', '有限公司', '有限责任公司', '责任公司', '股份公司', '集团公司', '集团总公司', '服务公司', '工程公司', '股份有限公司', '有限责任工司', '株式会社', '两合公司', '有限总公司', '总部',
                 '大药房有限公司', '农工商联合公司', '农工商公司', '农工商总公司', '酒店管理有限公司', '饭店管理有限公司', '旅行社有限公司', '设计院有限公司', '研究院有限公司', '医院有限公司', '服务区有限公司',
                 '银行股份有限公司', '.LTD', '劳司', '发展公司', '(集团)有限公司'}},
    '中心': {'.': types.tags_NM, '-': {},
    ...
    '工坊': {'.': types.tags_NO, '-': {},
           '+': {'油坊', '磨坊', '酒坊', "作坊", '工场', '联盟', '粉厂', '车厂', '酒厂', '钢厂', '铁厂', '门厂', '鞋厂', '炉厂', '煤厂', '瓦厂', '瓷厂', '石厂', '砖厂', '管厂', '箱厂', '纸厂', "柜厂",
                 '织厂', '肥厂', '胶厂', '船厂', '茶厂', '药厂', '表厂', '剂厂', '布厂', '床厂', '机厂', '件厂', '材厂', '板厂', '水厂', '油厂', '泵厂', "球厂", "纺厂", '车间', "木厂", "架厂", "轮厂",
                 "漆厂", "丝厂", "气厂", "灰厂", "矿厂", "砂厂", "米厂", "线厂", "网厂", "袋厂", "选厂", "锌厂", '盐厂', "窑厂", "灯厂", "烟厂", "香厂", "垫厂", '工区', '梁场', '沙场', '煤场', '盐场',
                 '石场', '砂场', "料场", "烘焙坊",
                 }},
    '加工场': {'.': types.tags_NM, '-': {},
            '+': {'总场', '屠宰场', '制梁场', '采石场', '停车场', '停车埸', '洗车场', '加工埸', "预制场", '拆解场', '存车场',
                  '拆车场', '试验场', '洗车坊'}},
    '基地': {'.': types.tags_NM, '-': {},
    ...
    '司法局': {'.': types.tags_NM, '-': {},
            '+': {'公安局', '审计局', '监察局', '公安厅', '派出所', '看守所', '司法所', '司法办公室',
    ...
    '职校': {'.': types.tags_NM, '-': {},
           '+': {'艺校', '驾校', '进修校', '体校', '技校', '鼓校', '业校', '中专', '职业中专', '卫校', '农校', '农广校', '农机校', '联合校', '技工学校', '技术学校', '职业中学校',
                 '培训学校', '中专学校', '工业学校', '老年大学', '党校', '团校', '专科学校', '干部学校', '职业中专校',
                 '医专', '行政管理学校', }},
    ...
    '省委': {'.': types.tags_NO, '-': {},
           '+': {'人民政府', '政府', '政协', '市委', '区委', '县委', '旗委', '州委', '村委', '工委', '建委', '教委', '纪委', '党委', '团委', '地委', '委会', '盟委', '村委会', '居委', '校友会', '商会', '学会', '街道办事处'}},
    '居委会': {'.': types.tags_NM, '-': {},
            '+': {'居民委', '居民委员会', '居民居委会', '民居委员会', '居民委会', '治理委员会', '居民事务中心', '街民委员会', '居民管理委员会', '家委会', '街道委员会',
                  '办事处', '街道办', '中心街道', '类似居委会', '商务公寓工作站', '民主议事会', '居民议事会', '社区工作站', "团场"}},
    '村民委会': {'.': types.tags_NM, '-': {},
             '+': {'联合村委会', '村民委员会', '村民委', '村民小组', '村名委员会', '村委员会', '村民村委员会', '直辖村民小组', '渔委会', '牧委会', '嘎查委会', '嘎查人民委员会',
                   '嘎查委员会', '牧民委员会', '村民议事会'}},
    '十字会': {'.': types.tags_NM, '-': {},
            '+': {'红十字会', '红十会'}},
    '工会': {'.': types.tags_NM, '-': {},
    ...
    '银行': {'.': types.tags_NM, '-': {'行走', '行为'},
           '+': {'分行', '总行', '商业银行', '农村商业银行', '农村合作银行', '工商银行', '邮政储蓄银行', '村镇银行', '信用联社', '农村信用联社', '中心信用社', '信用社', '基金会', '发展基金会', '教育基金会'}},
    '支行': {'.': types.tags_NB, '-': {},
    ...
    '营业部': {'.': types.tags_NO, '-': {},
            '+': {'供销社', '经销社', '经营部', '经销部', '营销部', '购销部', '销售部', '零售部', '租赁站', '购销站', '门市部', '销售处', '售票处', '经销处', '总经销',
                  '中心供销社', '中心售票处', '火车站营业部', '火车站门市部', }},
    '销部': {'.': types.tags_NO, '-': {},
           '+': {'经部', '配部', '总汇', }},
    ...
    '咖啡馆': {'.': types.tags_NO, '-': {},
            '+': {'茶艺居', '茶艺店', '茶艺苑', '茶艺馆', '茶饮店', '茶饮坊', '茶叶店', '茶庄行', '茗茶轩', '茶饮室', '茶艺坊', '茶艺室',
                  '咖啡厅', '茶坊店', '饮水店', }},
    '茶馆': {'.': types.tags_NO, '-': {},
    ...
    '宾馆': {'.': types.tags_NM, '-': {},
           '+': {'商务宾馆', '旅馆', '会馆', '酒店', '大酒店', '旅店', '招待所', '客栈', '度假村', '度假邨', '旅社', '客舍', '宾舍', '旅舍', '青年旅舍', '火车站旅馆',
                 '火车站宾馆', '中心酒店', '连锁酒店'}},
    '民宿': {'.': types.tags_NM, '-': {},
           '+': {'公寓', '居士林', '蒙古大营', '傣家园', '残疾人之家', '老年公寓', '商务公寓',
    ...
    '会所': {'.': types.tags_NO, '-': {},
           '+': {'美容会所', '养生会所', '休养所', "保健所", }},
    '俱乐部': {'.': types.tags_NM, '-': {},
            '+': {'足球俱乐部', '体育俱乐部', '青少年体育俱乐部', '健身俱乐部', '棋牌室', '舞厅', '歌舞厅', '歌厅', '地带', '骑行者之家', '休闲汇',
    ...
    # 地标店铺
    '万达店': {'.': types.tags_NO, '-': {},
            '+': {'火车站超市', '超市店', '中心文具店', '中学店', "小学店", "小区店", "国际店",
    ...
    '商场': {'.': types.tags_NM, '-': {},
           '+': {'购物广场', '商业大厦', '商埸', "展场", "家具广场", "商业广场", '通信广场', '家俬广场', '家居卖场', '家居名品馆', '家居广场',
    ...
    "制品店": {'.': types.tags_NO, '-': {},
            '+': {'名酒汇', '美食汇', '大全', '大全店', '总汇店', "玻璃店", "陶瓷店", "数码店", "家私店", '劳保店', '办公店',
                  "烟花爆竹店", "家纺店", "裁缝店", "商贸店", "汽配店", "轮胎店", "时装店", "男装店", "设计店", "水产店", "文体店", "制作店", "通信店", "汽修店", '芳叔店', '胡同店', '五交化店',
                  "家俱店", "厨具店", "渔具店", "灯具店", "日化店", "灯饰店", "花卉店", "综合店", "保健品店", "礼品店", "设备店", "母婴店", "家居店", "珠宝店", "南杂店", '校园店', '五金交化店',
                  "石材店", "水洗店", "装潢店", "修理行", "眼镜行", "维修行", "珠宝行", "建材行", '花园店', '花圃店', '苗圃店', '基地店', '农场店',
                  '大学店', '居然之家店', '公寓店', '书屋店', '供应店', '京东店'}},
    ...
    '火车站': {'.': types.tags_NO, '-': {},
            '+': {'汽车站', '中心站', '汽车客运站', '客运站', '铁路专用线', '枢纽台', '发运站台',
    ...
    '中华人民共和国': {'.': types.tags_NZ, '-': {},
                '+': {'中国共产党', '共产党', '中国共青团', '共青团', '中国人民解放军', '中国人民武装警察部队', '中国人民武警部队', '中国人民政治协商会议', '中国人民政协', '中国教育工会', '中国金融工会', '中国铁路工会',
                      '中国海员工会', '中国煤矿工会', '中国邮电工会', '中国民航工会', '中国财贸工会', '中国建筑工会', '中国交易工会', '中国联通工会',
                      }},
    ...
    '园区': {'.': types.tags_NS4, '-': {},
           '+': {'片区', '分区', '中心片', '监区', '林区', '矿区', '厂区', '坝区', '煤区', '分灌区', '新片区', '示范片', '林场区', '居民区', '小区', '住宅区', '分蓄洪区', '蓄洪区', '洪泛区',
                 ...
                 '职业教育园区', '农副产品加工交易园区', '汽车园区', '低碳经济园区', '创业园区', '工片区', '加工区', '信息园区', '商贸区', '风情区', '高开区', '经开园', '国际机场', '机场',
                 }},
    ...
    '办公区': {'.': types.tags_NS6, '-': {},
            '+': {'东区', '南区', '西区', '北区', '中区'}},
    '作业区': {'.': types.tags_NO, '-': {},
            '+': {'采区', '管护区', '管理区', '院区', '病区', '疗区', '灌区', '销售片区', '营销片区', '零售片区', '实验园区', '发展园区', '工业园区', '教育园区', '农业科技园区', '物流园区', '农业示范园区', '畜牧业示范园区', '生态示范园区',
                  '高科技示范园区', '科技示范园区', '技术实验园区', '扶贫产业园区', '育种园区', '国家农业科技园区', '储粮区', '科技园区', '文化科创园区', '社会福利园区', '综合服务园区', '监管中心园区', }},
    # 特殊区域尾缀的组织机构
    '马迹山港区': {'.': types.tags_NM, '-': {},
    ...
    '(字号加盟)': {'.': types.tags_NL, '-': {},
               '+': {'(加盟)', '(字号已加盟)', '(个体加盟)', '(东区)', '(西区)', '(南区)', '(北区)', '(流动)', '(上线)', '(下线)',
...
class tree_paths_t:
    ...
    score_maps = {'X': 0, 'U': 3, 'A': 5, 'N': 6, 'H': 7, 'S': 7, 'Z': 8, 'O': 8, 'B': 7, 'M': 9, 'L': 9, }
    unchars = {'(', ')', '<', '>', '"', "'"}
        ...
        if nseg[0] > seg[1]:  # 前后段分离
            ...
            if seg[1] - nseg[0] >= 2:  # 特定重叠多字的情况
                if seg[2] & nseg[2] & {types.NZ, types.NN}:
                    ds = 0
                elif seg[2] & {types.NA, types.NU, types.NN} and nseg[2] & {types.NA, types.NU, types.NN}:
                    ds = 0
                elif seg[2] & {types.NM, types.NO, types.NS, types.NZ, types.NN, types.NU} and nseg[2] & {types.NM, types.NO, types.NB}:
                    ds = 0
                ...
                elif segs and nidx >= 2 and nseg[1] - nseg[0] >= 3 and segs[nidx - 2][1] < segs[nidx - 1][0] and txt[seg[0] - 1] not in tree_paths_t.unchars:
                    ds = 0  # 特殊情况:seg与nseg相交,而seg的前面是未知分段,则尽量保留更长的nseg分段
                    ns = (nseg[1] - nseg[0]) * nsegt
                elif nseg[2] & {types.NB, types.NO, types.NM}:
                    if txt[nseg[0]] in {'省', '市', '区', '县', '乡', '镇', '村', '州', '旗'}:
