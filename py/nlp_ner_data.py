...
nt_tails = {
    ...
    '分店': {'.': {types.NB}, '-': {},
           '+': {'分号', '分厂', '分矿', '分校', '分团', '分公司', '子公司', '分工厂', '分司', '分工司', '支公司', '分部', '分局', '分院', '分所', '直属分局', '支局', '分园', '子厂', '分场', '分社',
                 '分站', "分会", "子站", "分队", "分处", '分台', '(分)局', '名胜区分公司', '机场分公司', '林场分公司', '牧场分公司', '火车站分公司', '火车站分社', '分馆', '分中心', '分门市部', '分门市',
                 '分诊所', '分病区', '分门诊', '中心分社', '中心支局', '中心支公司', '支校', '分校园', '分(院)', '分市场', '小分队', '一厂', '二厂', '一部', '二部', '三厂', '三部'}},
    ...
    '中央': {'.': {types.NS}, '-': {},
           '+': {'苏木', '嘎查', '嘎查村', '苏木村', '中心村', '苏木乡', '自治县', '自治州', '自治旗', '自治区', '民族乡', '新村', '古村', '民族苏木', '县城',
                 '华北', '东北', '华东', '华中', '华南', '西南', '西北', '中南', '东南', }},
    '与': {'.': {types.NA}, '-': {},
          '+': {'东部', '中部', '西部', '南部', '北部', '以东', '以西', '以南', '以北',
