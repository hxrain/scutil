...
nt_tails = {
    ...
    '博物馆': {'.': {types.NM, types.cultural}, '-': {},
            '+': {'文化馆', '科技馆', '纪念馆', '美术馆', '艺术馆', '档案馆', '图书馆', '教育馆', '体验馆', '艺馆', '科普馆', "娱乐厅", "展厅", "展览馆", "文献馆"}},
    ...
    # 地区/方位
    '中央': {'.': {types.NS}, '-': {},
           '+': {'华北', '东北', '华东', '华中', '华南', '西南', '西北', '东部', '中部', '西部', '中南', '北方', '南方', '东南', '中区', '东区', '南区', '西区', '北区', '南部', '北部',
                 '苏木', '嘎查', '以东', '以西', '以南', '以北', '嘎查村', '苏木村', '中心村', '苏木乡', '自治县', '自治州', '自治旗', '自治区', '民族乡', '新村', '古村', '民族苏木'}},
    '与': {'.': {types.NA}, '-': {},
          '+': {'大街', '大道', '东', '南', '西', '北', '省', '市', '区', '县', '州', '盟', '旗', '乡', '村', '镇', '屯', '组', '路', '街', '巷', '河', '道', '线', '段', '跨', '左', '右', '等',
    ...
    '科技园区': {'.': {types.NM, types.service, types.industry}, '-': {},
             '+': {'采区', '城市工业园区', '发展园区', '高教园区', '高科技园区', '高科园区', '高新技术产业园区', '工业园区', '工业园小区', '农高区', '科创区','经济园区',
