...
nt_tails = {
    ...
    '分店': {'.': types.tags_NB, '-': {},
           '+': {'分号', '分厂', '分矿', '分校', '分团', '分公司', '子公司', '分工厂', '分司', '分工司', '支公司', '分部', '分局', '分院', '分所', '直属分局', '支局', '分园', '子厂', '分场', '分社',
                 '分站', "分会", "子站", "分队", "分处", '分台', '(分)局', '名胜区分公司', '新机场分公司', '机场分公司', '林场分公司', '牧场分公司', '火车站分公司', '火车站分社', '分馆', '分中心', '分门市部', '分门市',
                 '分诊所', '分病区', '分门诊', '中心分社', '中心支局', '中心支公司', '支校', '分校园', '分(院)', '分市场', '小分队', '一厂', '二厂', '三厂', '分校区', '支中心',
                 '有限分公司', '酒店分公司', '大酒店分公司'}},
    ...
    '产业园': {'.': types.tags_NM, '-': {},
            '+': {'科技产业园', '创业园', '工业园', '软件园', '环保科技园', '科技园', '示范园', '物流园', '发展园', '绿色产业园', '电子商务产业园', '高新技术产业园', '农业示范园', '信息园',
                  }},
    '乐园': {'.': types.tags_NM, '-': {},
