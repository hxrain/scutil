...
nt_tails = {
    # 工矿企业
    '分店': {'.': types.tags_NB, '-': {},
           '+': {'分号', '分厂', '分矿', '分校', '分团', '分公司', '子公司', '分工厂', '分司', '分工司', '支公司', '分部', '经营分部', '分局', '分院', '分所', '直属分局', '支局', '分园', '子厂', '分场', '分社', '工会分会',
                 '分站', "分会", "子站", "分队", "分处", '分台', '(分)局', '名胜区分公司', '新机场分公司', '机场分公司', '林场分公司', '牧场分公司', '农牧场分公司', '畜牧场分公司', '火车站分公司', '火车站分社', '分馆',
                 '分诊所', '分病区', '分门诊', '中心分社', '中心支局', '中心支公司', '支校', '分校园', '分(院)', '分市场', '小分队', '分校区', '支中心', '分中心', '有限分公司', '酒店分公司', '大酒店分公司', '分院区'}},
    ...
    '公司': {'.': types.tags_NM, '-': {},
           '+': {'总公司', '有限公司', '有限责任公司', '责任公司', '股份公司', '集团公司', '集团有限公司', '集团有限责任公司', '集团总公司', '株式会社', '连锁有限公司', '大药房有限公司',
                 ...
                 '旅行社有限公司', '设计院有限公司', '研究院有限公司', '医院有限公司', '服务区有限公司', '两合公司', '银行股份有限公司', '有限总公司', '总部', '(集团)有限公司'}},
    '中心': {'.': types.tags_NM, '-': {},
    ...
    '学校': {'.': types.tags_NM, '-': {'学业'},
           '+': {'小学', '中学', '高中', '职业高中', '总校', '中心学校', '职业中学', '附属中学', '中心中学', '二校区', '中心校区', '中心初中', '中心总校', '中心完小', '中心初级中学',
    ...
    '委员会': {'.': types.tags_NM, '-': {},
            '+': {'工会委员会', '工作委员会', '管理委员会', '常委会', '人大常委会', '管委会', '组委会', '工作委', '常务委', '政法委', '管理委', '卫健委', '发改委', '工会委', '文化委', '文卫委', '旅发委',
                  '大学委员会', '纪工委', '纪检委', '计生委', '生态管理委员会', '建设管理委员会', '筹委会', '监事会', '中心委员会', '中心委', '中心校委员会', '中心局委员会',
                  }},
    '省委': {'.': types.tags_NO, '-': {},
    ...
    '商店': {'.': types.tags_NM, '-': {'店内', '门市内', '市面'},
           '+': {'专门店', '专营店', '专业店', '精品店', '用品店', '日用品店', '产品店', '便利店', '加盟店', '旗舰店', '总店', '销售店', "代理店", "专属代理店", '平价综合商店',
                 '零售店', '经销店', '直营店', '经营店', '妆品店', '化妆品店', '批发店', '卖店', '特产店', '小卖店', '综合门市', "双代店", '中心超市', '平价菜铺', '平价商店',
    ...
    '五金店': {'.': types.tags_NO, '-': {},
            '+': {'艺品店', '生活馆', "家电店", '饰品店', "钢材店", "水泥店", "卫浴店", "宠物店", "理疗店", "瓷砖店", "护肤店", '傢俬店', '家俬店', '仓储店', "美妆店", "孕婴店", "装修店", "保健店", "工具店",
                  ...
                  '电器店', '加工店', "玉器店", "花圈店", '通讯店', '农资店', '电脑店', "电动车店", "护肤品店", "不锈钢店", }},
    ...
    '装卸码头': {'.': types.tags_NM, '-': {},
             '+': {'公司航空港', '客运主枢纽', '航电枢纽', '重件码头', '服务码头', '渔港监督', '粮港', '公铁联运港', '农垦货运港'}},
    '火车站': {'.': types.tags_NO, '-': {},
    ...
    '中央': {'.': types.tags_NS, '-': {},
           '+': {'苏木', '嘎查', '嘎查村', '苏木村', '中心村', '苏木乡', '自治县', '自治州', '自治旗', '自治区', '民族乡', '新村', '古村', '民族苏木',
                 '华北', '东北', '华东', '华中', '华南', '大街', '支路', '大道', '东路', '西路', '南路', '北路', '中路', '广场', '县城', }},
    '与': {'.': types.tags_NA, '-': {},
          '+': {'东部', '中部', '西部', '南部', '北部', '以东', '以西', '以南', '以北', '东西', '南北', '西南', '西北', '中南', '东南', '/', '·', '.', '-', '、', '&',
                '省', '市', '县', '乡', '州', '盟', '旗', '办', '及', '至', '段', '暨', '区', '新', '老', '原', '女', '驻', '和', '的', '东', '南', '西', '北',
                '村', '镇', '路', '街', '道', '港', '公司村',
                # '或', '含', '居', '内', '外', '上', '下', '小', '案', '报', '旁', '等', '总', '前', '后', '堂', '侧', '跨', '左', '右', '线', '旧', 'A', 'B', 'C', 'D', 'E',
                }},
    ...
    '社区': {'.': types.tags_NS5, '-': {},
           '+': {'街道', '集体资产社区', '组团虚拟社区', '直属社区', '直属虚拟社区', '虚拟社区', '虚拟生活区', '生活区', '类似社区', '联合小区', '产业社区', '工业社区', '类似乡级单位', '特殊社区',
                 ...
                 '火车站社区', '花园', '农场社区', '总场社区', '林场社区', '工业园小区', '辖区', '联办村', '南社区', '东社区', '西社区', '北社区'}},
    # 院校/加油站的南北区
    '办公区': {'.': types.tags_NS6, '-': {},
            '+': {'东区', '南区', '西区', '北区', '中区'}},
    '作业区': {'.': types.tags_NO, '-': {},
