...
nt_tails = {
    ...
    '分店': {'.': types.tags_NB, '-': {},
           '+': {'分号', '分厂', '分矿', '分校', '分团', '分公司', '子公司', '分工厂', '分司', '分工司', '支公司', '分部', '经营分部', '分局', '分院', '分所', '直属分局', '支局', '分园', '子厂', '分场', '分社',
                 ...
                 '分诊所', '分病区', '分门诊', '中心分社', '中心支局', '中心支公司', '支校', '分校园', '分(院)', '分市场', '小分队', '一厂', '二厂', '三厂', '分校区', '支中心', '分中心', '分门市部', '分门市',
    ...
    '中央': {'.': types.tags_NS, '-': {},
           '+': {'苏木', '嘎查', '嘎查村', '苏木村', '中心村', '苏木乡', '自治县', '自治州', '自治旗', '自治区', '民族乡', '新村', '古村', '民族苏木',
                 '华北', '东北', '华东', '华中', '华南', '西南', '西北', '中南', '东南', '大街', '支路', '大道', '东西', '南北'}},
    '与': {'.': types.tags_NA, '-': {},
          '+': {'县城', '东部', '中部', '西部', '南部', '北部', '以东', '以西', '以南', '以北', '前', '后', '港', '团', '中',
    ...
    '店': {'.': types.tags_NO, '-': {}, '+': {'站店', '堂店', '院店', '苑店', '园店', '轩店', '斋店', }},
