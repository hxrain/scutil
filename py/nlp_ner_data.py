...
nt_tails = {
    ...
    '中华人民共和国': {'.': {types.NF, types.gov}, '-': {},
                '+': {'中国共产党', '共产党', '共青团', '新疆生产建设兵团', '生产建设兵团', '中城建', '中电信', '中国网通', '中电建', '中铁建', }},

    # 地区/方位
    '中央': {'.': {types.NS}, '-': {},
           '+': {'苏木', '嘎查', '嘎查村', '苏木村', '中心村', '苏木乡', '自治县', '自治州', '自治旗', '自治区', '民族乡', '新村', '古村', '民族苏木', '县城'}},
    '与': {'.': {types.NA}, '-': {},
          '+': {'华北', '东北', '华东', '华中', '华南', '西南', '西北', '东部', '中部', '西部', '中南', '北方', '南方', '东南', '中区', '东区', '南区', '西区', '北区', '南部', '北部', '以东', '以西', '以南', '以北',
                '大街', '大道', '东', '南', '西', '北', '省', '市', '区', '县', '州', '盟', '旗', '乡', '村', '镇', '屯', '组', '路', '街', '巷', '河', '道', '线', '段', '跨', '左', '右', '等',
                '新', '旧', '老', '原', '含', '驻', '办', '居', '女', '至', '暨', '和', '及', '内', '外', '上', '下', '小', '案', '报', '旁', '的', '/', '.', '-', '、', '&', 'A', 'B', 'C', 'D', 'E',
                }},
    ...
    '地区': {'.': {types.NS3}, '-': {},
           '+': {'开发区', '新区', '创新区', '托管区', '保护区', '经开区', '管区', '保护开发区', '保税区', '边境经济合作区', '产业集聚区', '经发区', '产能区',
                 ...
                 '商贸物流枢纽区', '投资区', '经技区', '航空区', '农高区', '科创区', '工业示范区', }},
    ...
    '片区': {'.': {types.NS4, types.service}, '-': {},
           '+': {'疗区', '监区', '林区', '矿区', '厂区', '坝区', '煤区', '分灌区', '新片区', '示范片', '林场区', '病区', '居民区', '小区', '住宅区', '分蓄洪区', '蓄洪区', '洪泛区', '园区', '分区', '中心片',
                 '保税港区', '航空港区', '核心港区', '港区', '特别行政管理区', '农垦管理区', '华侨管理区', '经济管理区', '垦区', '围垦区', '资源区', '物业区', '空港区', '功能区', '警备区', '实验区', '安置区',
                 '生态管理区', '旅游区', '文化旅游区', '海湾旅游区', '生态文化旅游区', '风景旅游区', '生态旅游区', '边贸旅游区', '特别管理区', '风景名胜管理区', '旅游管理区', '港务区', '国际港务区',
    ...
    '社区': {'.': {types.NS5, types.gov}, '-': {},
           '+': {'街道', '集体资产社区', '组团虚拟社区', '直属社区', '直属虚拟社区', '虚拟社区', '虚拟生活区', '生活区', '类似社区', '联合小区', '产业社区', '工业社区', '类似乡级单位', '特殊社区',
                 ...
                 '火车站社区', '花园', '农场社区', '总场社区', '林场社区', '工业园小区', }},
    '作业区': {'.': {types.NM, types.service, }, '-': {},
            '+': {'采区', '管护区', '管理区', '院区', '灌区', '销售片区', '营销片区', '零售片区', '发展园区', '工业园区', '教育园区', '农业科技园区', '物流园区', '农业示范园区', '畜牧业示范园区', '生态示范园区',
                  '科技示范园区', '技术实验园区', '扶贫产业园区', '育种园区', '国家农业科技园区', '储粮区', '科技园区', '加工区', '文化科创园区', '社会福利园区', '综合服务园区', '监管中心园区', }},
    # 特殊区域尾缀的组织机构
    '马迹山港区': {'.': {types.NM, types.service}, '-': {},
              '+': {'鹤洲北垦区', '洪塘现代农业园区', '水莲花生态农业园区', '生态循环农业园区'}},

    '产业园': {'.': {types.NM, types.industry, types.service}, '-': {},
            '+': {'科技产业园', '创业园', '工业园', '软件园', '科技园', '示范园', '物流园', '发展园', '绿色产业园', '电子商务产业园', '高新技术产业园', '农业示范园',
                  }},
    '乐园': {'.': {types.NM, types.cultural}, '-': {},
    ...
    '(有限公司)': {'.': {types.NL, types.com}, '-': {},
               '+': {'(有限责任)', '(有限责任公司)', '(股份有限公司)', '(公司)', }},
    '(个人独资)': {'.': {types.NL, types.service}, '-': {},
               '+': {'(个体工商户)', '(无字号名称)', }},
