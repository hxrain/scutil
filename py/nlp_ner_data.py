...
nt_tails = {
    ...
    '校区': {'.': types.tags_NO, '-': {},
           '+': {'东校区', '南校区', '西校区', '北校区', '新校区', '小学部', '初中部', '高中部', }},
    '职校': {'.': types.tags_NM, '-': {},
    ...
    '省委': {'.': types.tags_NO, '-': {},
           '+': {'市委', '区委', '县委', '旗委', '州委', '村委', '纪委', '团委', '地委', '委会', '盟委', '村委会', '居委', '校友会', '商会', '学会', }},
    '居委会': {'.': types.tags_NM, '-': {},
            '+': {'居民委', '居民委员会', '居民居委会', '民居委员会', '居民委会', '治理委员会', '居民事务中心', '街民委员会', '居民管理委员会', '家委会', '街道委员会', '街道办事处',
    ...
    '茶馆': {'.': types.tags_NM, '-': {},
           '+': {'茶社', '茶楼', '茶座', '茶都', '茶莊', '茶艺居', '茶艺店', '茶艺苑', '茶艺馆', '茶饮店', '茶饮坊', '茶叶店', '茶居', '茶荘', '茶庄', '茶庄行', '茗茶轩', '茶轩', '茶饮室', '茶艺坊', '茶艺室',
    ...
    '酒馆': {'.': types.tags_NO, '-': {},
           '+': {'汤馆', '粉馆', '肉馆', '鱼馆', '饼家', '鱼庄', '馍房', "奶吧", "水吧", "烤吧", "饼屋", "串店", "汤店", '粮店', '油店', '粉店', '肉店', '菜店', '面店', '鸡店', '茶店', '鸭店', "果行", "馕店", "鱼店",
                 "馍店", '饮舍', "饮吧", "奶店", "米店", "食坊", '庄园', '快餐', '饼店', '酒家', '茶舍', '网吧', '网咖', "味馆", }},
    ...
    '食品店': {'.': types.tags_NM, '-': {},
            '+': {'新鲜屋', '甜品店', '饮品店', '汉堡店', '包子店', '水果店', '蛋糕房', '食品门市', '食品超市', '水果超市', '副食部', '餐饮部', '蛋糕店', "包子铺",
                  '副食超市', '生鲜超市', "馒头店", "鸡排店", "冰淇淋店", "糕点店", "烘焙店", "凉皮店", "果蔬店", "水饺店", "面包坊", "蛋糕坊", "豆腐坊", "鸭脖店", "豆腐店", "披萨店",
                  "火烧店", "鲜果店", "饮料店", "调料店", "点心店", "饺子店", "寿司店", "卤味店", "果品店", "小炒店", "面皮店", "砂锅店", "馄饨店", "海鲜店", "生鲜店", "面包房",
                  "甜品站", '海鲜港', '南食店', '食品城', '饺子城', '中心粮店', '美食花园', '啤酒花园'}},
    '酒庄': {'.': types.tags_NM, '-': {},
    ...
    '宾馆': {'.': types.tags_NM, '-': {},
           '+': {'商务宾馆', '旅馆', '会馆', '酒店', '大酒店', '旅店', '招待所', '客栈', '度假村', '度假邨', '旅社', '客舍', '宾舍', '旅舍', '青年旅舍', '火车站旅馆',
                 '火车站宾馆', '中心酒店', '连锁酒店'}},
    '民宿': {'.': types.tags_NM, '-': {},
           '+': {'公寓', '农庄', '居士林', '蒙古大营', '傣家园', '残疾人之家', '老年公寓', '商务公寓',
    ...
    '商店': {'.': types.tags_NM, '-': {'店内', '门市内', '市面'},
           '+': {'门店', '专门店', '专营店', '专业店', '精品店', '用品店', '日用品店', '产品店', '便利店', '加盟店', '旗舰店', '总店', '销售店', "代理店", "专属代理店", '平价综合商店',
                 ...
                 '五金店', '便民店', '器材店', '建材店', '眼镜店', '装饰店', '手机店', '材料店', '科技店', '电器店', '加工店', '艺品店',
    ...
    '坊店': {'.': types.tags_NO, '-': {},
           '+': {'金店', '花店', '包店', '锁店', "花坊", '货店', "布店", '之家', '花舍', '衣舍', '鞋店', '门市', '名店', '新店', '支店', '阁店', '书店', '鞋荘', "商社", '中心店', "道馆", '书屋', }},
    # 地标店铺
    '万达店': {'.': types.tags_NM, '-': {},
    ...
    '商场': {'.': types.tags_NM, '-': {},
           '+': {'购物广场', '商厦', '商业大厦', '商埸', "展场", "家具广场", "商业广场", '通信广场', '家俬广场', '家居卖场', '家居名品馆', '家居广场',
    ...
    '商号': {'.': types.tags_NO, '-': {'号角', '号手', '号声'},
           '+': {'南货号', '山茶号', '自行车号', '仓买', '商行', '琴行', '茶行', '酒行', '金行', "漆店", "鞋行", "烟店", "布行", '柜台', '专柜', '药柜', '码头店', '书城', '商城', '卖场', '商都', }},
    "制品店": {'.': types.tags_NM, '-': {},
            '+': {'名酒汇', '美食汇', '大全', '大全店', '总汇店', "玻璃店", "陶瓷店", "数码店", "家私店", '劳保店', '办公店',
                  ...
                  '商场店', '市场店', '广场店', '中心广场店', '机场店', '飞机场店', '体育场店', '商城店', '商贸城店', '锁城店', '大学店', '居然之家店', '公寓店', '书屋店', '供应店', '京东店'}},
