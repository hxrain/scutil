...
nt_tails = {
    ...
    '中心': {'.': {types.NM, types.gov, types.service}, '-': {'心里', '心理', '心中', '心智', '心情', '心思', '心脏', '心脑', '心内', '心外'},
           '+': {'服务中心', '管理中心', '培训中心', '运动中心', '旅游开发管理中心', '行政事务管理中心'}},
    ...
    '委员会': {'.': {types.NM, types.org}, '-': {},
            '+': {'工会委员会', '工作委员会', '管理委员会', '常委会', '人大常委会', '管委会', '组委会', '委会', '区委', '县委', '纪委',
                  ...
                  '纪工委', '纪检委', '经贸工委', '计生委', '生态管理委员会', '建设管理委员会',
                  }},
    '居委会': {'.': {types.NM, types.org}, '-': {},
            '+': {'村民委员会', '村委会', '村委', '居民委', '村民委', '居民委员会', '居民居委会', '居民委会', '村民委会', '治理委员会', '地区居委会', '街道', '街道办事处', '办事处', '居民事务中心',
                  '直辖村民小组', '渔委会', '居委', '村民小组', '村名委员会', '村委员会', '村民村委员会', '街民委员会', '居民管理委员会', '家委会', '嘎查委会', '嘎查人民委员会', '嘎查委员会', '街道委员会',
                  '联合村委会'}},
    ...
    '产业园': {'.': {types.NM, types.industry, types.service}, '-': {},
            '+': {'科技产业园', '创业园', '工业园', '软件园', '科技园', '创新园', '示范园', '物流园', '发展园', '绿色产业园'}},
    '地区': {'.': {types.NS}, '-': {},
           '+': {'托管区', '保护区', '资源区', '管护区', '管理区', '管区', '灌区', '垦区', '库区', '林区', '保护开发区', '保税港区', '保税区', '边境经济合作区', '产业集聚区', '产业经济开发区', '产业聚集区',
                 ...
                 '经济技术开发区', '经济开发区', '经济开发试验区', '经济开发新区', '经济贸易开发区', '经济区', '经济特区', '经济综合实验区', '军区', '开发分区', '开发区', '开放开发区', '科技经济开发区',
                 '跨境工业区', '老工业区', '林场管理区', '临港商务区', '贸易开发区', '民营经济发展区', '民营经济开发区', '新兴产业集中区', '产业集中区', '现代农业示范区', '商品经营开发区', '新经济产业集聚区',
                 '民营区', '农垦管理区', '农业高新区', '农业经济开发区', '农业开发区', '农业综合开发区', '片区', '汽车产业开发区', '商贸经济示范区', '商贸示范区', '商务区', '新兴技术开发区', '合作产业开发区',
                 '生态经济开发区', '示范区', '水库灌区', '特别管理区', '特别行政管理区', '特别合作区', '特区', '特色农业经济开发区', '外商投资工业区', '外向型工业加工区', '高技术产业开发区', '外向型农业开发区',
                 '稀土高新区', '现代产业区', '现代农业产业示范区', '新技术开发区', '新建工业区', '新建区', '新区', '循环工业发展区', '循环经济开发区', '沿海经济开发区', '生态综合开发区', '先进制造业开发区',
    ...
    '景区': {'.': {types.NS, types.cultural}, '-': {},
           '+': {'风景旅游区', '风景名胜区', '风景区', '风景游览区', '名胜风景区', '旅游度假区', '旅游渡假区', '旅游管理区', '旅游经济开发区', '旅游景区', '旅游开发区', '旅游区', '温泉风景区', '温泉疗养旅游开发区',
                 ...
                 '商业文化旅游中心区', '生态文化旅游示范区'}},
    '园区': {'.': {types.NS, types.service, types.industry}, '-': {},
           '+': {'北区', '采区', '产业园区', '城市工业园区', '东区', '发展园区', '服务区', '高教园区', '高科技园区', '高科园区', '高新技术产业园区', '高新技术示范园区', '工业园区', '工业园小区', '国家农业科技园区',
                 ...
                 '校区', '新产业园区', '新技术产业园区', '新型工业园区', '循环经济产业园区', '院区', '中心商务区', '专利技术园区', '工业园管理区', '制造工业园区', '承接产业转移集中示范园区', '集中示范园区',
                 '现代产业园区', '生态农业园区', '现代服务业园区', '农副产品加工交易园区', '交易园区', '农业园区', '商务商贸街区', '现代农牧业园区', '生物科技产业园区', '农机产业园区', '装备制造产业园区',
                 '现代农业产业园区', '农业产业园区', '家纺产业园区', '现代农业示范园区', '农业示范园区', '能源化工园区'}},
    '社区': {'.': {types.NS, types.service, types.industry}, '-': {},
           '+': {'集体资产社区', '组团虚拟社区', '直属社区', '直属虚拟社区', '虚拟社区', '虚拟生活区', '生活区', '类似社区', '联合小区', '产业社区', '工业社区', '社区工作站', '类似乡级单位', '直辖村级区划'}},
    ...
    '种植场': {'.': {types.NM, types.farming}, '-': {},
            '+': {'花圃', '苗圃', '桃园', '梨园', '茶园', '菜园', '果园', '园艺', '大棚', '种植园', '农场', '木场', '林场', '果场', '苗场', '茶场', '菜场', '花木场',
                  ...
                  '蔬菜温室大棚', '养殖地', '橡胶地', '种植地', '总埸', '林埸', '种植示范小区', '营林区', "发展场", "农林发展场", "农业发展场", "蔬菜发展场", }},
