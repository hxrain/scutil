...
class types(Enum):
    ...
    NS1 = 121  # 省/自治区/直辖市
    NS2 = 122  # 地级市/州/盟
    NS3 = 123  # 区/县/旗 (地区/开发区/景区)
    NS4 = 124  # 乡镇/街道/苏木 (园区/工业园/度假区)
    NS5 = 125  # 村屯/社区/嘎查/农场/林场/牧场/渔场 (公园/游乐园)

    # NT层级
    L0 = 200  # 组织层级0 - 全国性的集团总公司/国家级政府机构(部/司)
    L1 = 201  # 组织层级1 - 公司主体/组织核心/省市区县级的行政机构(厅/处/局)
    L2 = 202  # 组织层级2 - 分公司/分厂/村镇级行政机构(科/室/站)
    L3 = 203  # 组织层级3 - 个体经营摊点/小微组织
