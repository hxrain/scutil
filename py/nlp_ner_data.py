...
nt_tails = {
    ...
    '学校': {'.': types.tags_NM, '-': {'学业'},
           '+': {'小学', '小学校', '中学', '中学校', '高中', '职业高中', '中心校', '总校', '中心学校', '武校', '盲校', '网校', '聋校', '联校', '公学', '职业中学', '附属中学', '中心小学校', '中心中学',
    ...
    '片区': {'.': types.tags_NS4, '-': {},
           '+': {'园区', '分区', '中心片', '疗区', '监区', '林区', '矿区', '厂区', '坝区', '煤区', '分灌区', '新片区', '示范片', '林场区', '居民区', '小区', '住宅区', '分蓄洪区', '蓄洪区', '洪泛区',
                 ...
                 '职业教育园区', '农副产品加工交易园区', '汽车园区', '低碳经济园区', '创业园区', '工片区', '加工区', '信息园区', '商贸区', '风情区',
                 }},
    '社区': {'.': types.tags_NS5, '-': {},
    ...
    '产业园': {'.': types.tags_NM, '-': {},
            '+': {'科技产业园', '创业园', '工业园', '软件园', '科技园', '示范园', '物流园', '发展园', '绿色产业园', '电子商务产业园', '高新技术产业园', '农业示范园', '信息园',
                  }},
    '乐园': {'.': types.tags_NM, '-': {},
