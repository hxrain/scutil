...
nt_tails = {
    ...
    '委员会': {'.': {types.NM, types.gov}, '-': {},
            '+': {'工会委员会', '工作委员会', '管理委员会', '常委会', '人大常委会', '管委会', '组委会', '委会', '区委', '县委', '纪委', '团委', '市委', '省委', '地委', '旗委', '州委',
    ...
    '与': {'.': {types.NA}, '-': {},
          '+': {'大街', '大道', '东', '南', '西', '北', '省', '市', '区', '县', '州', '盟', '旗', '乡', '村', '镇', '屯', '组', '路', '街', '巷', '河', '道', '线', '段', '跨', '左', '右',
                '新', '旧', '老', '原', '含', '驻', '办', '居', '女', '至', '暨', '和', '及', '内', '外', '上', '下', '案', '报', '旁', '的', '/', '.', '-', '、', 'A', 'B', 'C', 'D', 'E',
                }},
    ...
    '片区': {'.': {types.NS4, types.medical}, '-': {},
           '+': {'疗区', '监区', '矿区', '坝区', '煤区', '新片区', '示范片', '病区', '居民区', '小区', '住宅区', '分蓄洪区', '蓄洪区', '洪泛区', '园区'}},
