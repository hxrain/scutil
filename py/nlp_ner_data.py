...
nt_tails = {
    ...
    '工厂': {'.': {types.NM, types.industry}, '-': {},
           '+': {'加工厂', '化工厂', '学区', '工区', '件厂', '剂厂', '布厂', '床厂', '总厂', '机厂', '材厂', '板厂', '水厂', '油厂', '泵厂', '工廠', '净水厂', '纯水厂', '纯净水厂',
                 ...
                 "香厂", "实验厂", '选煤厂', '车间', '采油厂', '盐厂', '窗纱厂', '火柴厂', '制作厂', '工加厂', '分车间'}},
    '电厂': {'.': {types.NM, types.energy}, '-': {},
           '+': {'发电厂', '电站', '发电站', '水电站', '核电站', '供电局', '供电所', "风电场"}},
    '公司': {'.': {types.NM, types.com}, '-': {},
           '+': {'总公司', '有限公司', '有限责任公司', '责任公司', '股份公司', '集团公司', '集团有限公司', '集团有限责任公司', '集团总公司', '株式会社', '顾问有限公司',
                 '服务公司', '工程公司', '实业有限公司', '股份有限公司', '保险股份有限公司', '开发有限公司', '设备有限公司', '发展有限公司', '经纪有限公司', '管理有限公司', '工程有限公司',
                 '建设发展有限公司', '设计有限公司', '建设有限公司', '制造有限公司', 'LTD.', 'LTD', '劳司', '工司', '有限责任工司', '农工商联合公司', '农工商公司', '农工商总公司'}},
    ...
    '中心': {'.': {types.NM, types.gov, types.service}, '-': {'市中心', '省中心', '区中心'},
           '+': {'服务中心', '管理中心', '培训中心', '运动中心', '旅游开发管理中心', '行政事务管理中心', '安置中心', '副中心'}},
    '矿区': {'.': {types.NM, types.mining}, '-': {},
           '+': {'矿井', '煤矿', '金矿', '铁矿', '气矿', '盐矿', '石矿', '砂矿', '硅矿', '钙矿', '钛矿', '钨矿', '铅矿', '钼矿', '铀矿', '铜矿', '铝矿', '锡矿', '硫铁矿',
                 '锌矿', '锰矿', '联营矿', '金属矿', '原料矿', '有色矿', '露天矿', '磷矿'}, '-': {'采矿', '探矿', '洗矿', '矿长', }},
    ...
    '基金会': {'.': {types.NM, types.financial},
            '+': {'基金', '发展基金会', '教育基金会', '产业基金', '发展基金', '投资基金'}, '-': {'基金管理', '基金投资'}},
    ...
    '福利院': {'.': {types.NM, types.service}, '-': {},
            '+': {'护理院', '敬老院', '养老院', '社会福利院', '农村福利院', '儿童福利院', '保育院', "互助会", "慈善会", "光荣院", '福利会', '救助会'}},
    ...
    '饭庄': {'.': {types.NM, types.catering}, '-': {},
           '+': {'面莊', '饭莊', '鱼莊', '羊肉府', '美食府', '食府', '美食荟', '美食都', '鱼府', '干锅居', '火锅居', '砂锅居', '美食居', '饺子居', '饭桩', "饭堂",
                 ...
                 '炖鱼村', '江鱼村', '渔村', '火锅村', '烙馍村', '美食村', '莜面村', '饺子村', "餐部", "味馆", "餐饮馆", '肥牛城'}},
    '档口': {'.': {types.NM, types.catering, types.retail}, '-': {},
           '+': {'专档', '干调档口', '面档口', '饭档口', }},
    '海鲜舫': {'.': {types.NM, types.catering}, '-': {},
            '+': {'海鲜鲂', '河鲜舫', '湖鲜舫', '蟹舫', '夜宵舫'}},
    '家常菜': {'.': {types.NM, types.catering}, '-': {},
            '+': {'私房菜', '小饭桌', '小餐桌', '汤馆', '粉馆', '肉馆', '酒馆', '面馆', '鱼馆', '农家菜馆', '饼家', '小吃店', '小吃坊', '小吃亭', '小吃城', '快餐城', '海鲜城', '小吃屋'}},
    ...
    '宾馆': {'.': {types.NM, types.tourism, types.catering}, '-': {},
           '+': {'商务宾馆', '旅馆', '会馆', '公馆', '酒店', '大酒店', '旅店', '招待所', '客栈', '度假村', '度假邨', '旅社', '客舍', '宾舍', '宿舍', '旅舍', '青年旅舍', '火车站旅馆', '火车站宾馆'}},
    '民宿': {'.': {types.NM, types.tourism}, '-': {},
           '+': {'公寓', '客莊', '山莊', '庄园', '农庄', '山庄', '大院', '居士林', '蒙古大营', '傣家园', '农家园', '残疾人之家', '老年公寓', '商务公寓',
    ...
    '教会': {'.': {types.NM, types.relig}, '-': {},
           '+': {'天主堂', '教堂', '天主教下会点', '天主教公所', '天主教堂', '天主教活动场所', '天主教祈祷所', '天主教爱国会', '基督教三自爱国会', '基督教青年会'}},
    # 洗浴会所
    '浴池': {'.': {types.NM, types.service}, '-': {},
           '+': {'康浴园', '浴部', '泉浴城', '浴吧', '浴场', '浴室', '浴宫', '浴池店', '浴池部', '浴苑', '浴都', '淋浴厅', '淋浴店', '休闲池', '药池', "浴馆", '洗浴广场'}},
    ...
    '理发店': {'.': {types.NM, types.service}, '-': {},
            '+': {'发艺', '发典', '发厅', '发廊', '美发店', '美甲店', '美容店', '按摩店', '足浴店', '美容馆', '养生馆', '发荘', "发室", "理发室", "发屋", "发艺店",
    ...
    '商店': {'.': {types.NM, types.retail}, '-': {'店内', '市内', '市面'},
           '+': {'门店', '专门店', '专营店', '专业店', '小店', '精品店', '用品店', '日用品店', '产品店', '便利店', '加盟店', '旗舰店', '总店', '销售店', "代理店", "专属代理店",
                 ...
                 "家电店", "理疗店", "瓷砖店", "护肤店", '傢俬店', '家俬店', '仓储店'}},
    '商贸行': {'.': {types.NM, types.retail}, '-': {},
            '+': {'寄卖行', '拍卖行', '电器行', '典当行', '贸易行', '电脑行', '通讯行', '租赁行', '装饰行', '批发行', '量贩', '加油港', '汽车港', '鲜花港', "道馆", "家居馆", '加油城'}},
    '商贸城': {'.': {types.NM, types.retail}, '-': {},
            '+': {'娱乐城', '家具城', '电器城', '不夜城', '电子城', '生态城', '科技城', '家电城', '家私城', '电脑城', '汽车城', '美食城', '装饰城', '自行车城', "家俱城", "鞋城", '电信城', '通信城',
                  '傢俬城', '家俬城', '批发城', '厨卫城', '建材城', '钢琴城', '五金机电城'}},
    '商场': {'.': {types.NM, types.retail}, '-': {},
           '+': {'书城', '商城', '卖场', '商都', '购物广场', '小世界', '大世界', '商厦', '商业大厦', '商埸', "展场", "家具广场", "商业广场", '通信广场', '家俬广场',
    ...
    '百货': {'.': {types.NM, types.retail}, '-': {'家居用品'},
           '+': {'百货店', '百货商店', '百货商场', '百货大楼', '总代理', '家居卖场', '家居名品馆', '家居广场', '家居形象店', '百货广场'}},
    ...
    '用品世界': {'.': {types.NM, types.retail}, '-': {},
             '+': {'化妆品世界', '女人世界', '娱乐世界', '家具世界', '文化世界', '欢乐世界', '水上世界', '游乐世界', '溜冰世界', '玩具世界', '男仕世界', '礼品世界', '箱包世界',
                   '精品世界', '花卉世界', '茶叶世界', '音像世界', '食品世界', '乒乓世界', '魅力世界'}},
    ...
    '商行': {'.': {types.NM, types.retail}, '-': {},
           '+': {'琴行', '茶行', '车行', '酒行', '金行', '总汇', '傢俬', '家俬', '木雕世家', '名酒汇', '美食汇', '大全', '大全店', '总汇店', "烟店", "玻璃店", "陶瓷店", "数码店", "家私店",
                 "烟花爆竹店", "纺店", "家纺店", "裁缝店", "商贸店", "汽配店", "轮胎店", "时装店", "男装店", "设计店", "水产店", "文体店", "制作店", "通信店", "汽修店", '芳叔店', '胡同店',
                 "家俱店", "厨具店", "渔具店", "灯具店", "日化店", "灯饰店", "花卉店", "综合店", "保健品店", "制品店", "礼品店", "设备店", "母婴店", "家居店", "珠宝店", "南杂店", '校园店',
                 "石材店", "水洗店", "漆店", "装潢店", '花舍', '衣舍', "修理行", "眼镜行", "鞋行", "维修行", "珠宝行", "布行", "建材行", '花园店', '花圃店', '苗圃店', '基地店', '农场店',
                 '商场店', '市场店', '广场店', '机场店', '飞机场店', '体育场店', '商城店', '商贸城店', '锁城店', '码头店', '大学店', '居然之家店', '公寓店', '书屋店', '供应店', '京东店'}},
    ...
    '仓库': {'.': {types.NM, types.logistics}, '-': {'库内', '库存', '库中'},
           '+': {'储备库', '粮食储备库', '直属库', '粮库', '仓储部', '仓储场', '仓储站', '粮站', '货仓', '资料仓', '配送仓', '供应仓', '保税仓', '保管仓', '前置仓', '副食仓', '化肥仓', '工艺仓', '布仓',
                 '批发仓', '批发货仓', '物资仓', '盐仓', '监管仓', '粮仓', '肥料仓', '中心库', '(配送)库', '中转库', '仓储库', '供应总库', '保税库', '保鲜库', '储备库', '储藏库', '米粮库',
                 '冷库', '冷藏库', '冻库', '分库', '化肥库', '器材库', '购销库', '寄售库', '总库', '恒温库', '收储库', '收纳库', '果品库', '气瓶库', '沥青库', '油库', '油脂库', '物资库',
                 '储运库', '直管库', '石油气库', '糖库', '装备库', '配送库', '仓储栈', '储运栈', '转运栈', '煤栈', '煤炭仓储栈', '货栈', '贸易栈', '贸易货栈', '暖车库', '车库', '保管场'}},
    ...
    '种植场': {'.': {types.NM, types.farming}, '-': {},
            '+': {'花圃', '苗圃', '茶园', '菜园', '果园', '种植园', '农场', '木场', '林场', '果场', '苗场', '茶场', '菜场', '花木场', '竹木场', '储林场', '农作物种植场', "实验农场",
                  '苗木基地', '种植基地', '植物园', '花园', '苗圃场', '花木园', '国有林场', '园艺场', '绿化园', '农业园', '花卉园', '生态园', '核桃园', '樱桃园', '农作物原种场',
                  '养殖地', '橡胶地', '种植地', '总埸', '林埸', '种植示范小区', '营林区', "发展场", "农林发展场", "农业发展场", "蔬菜发展场", '示范农场', '经营林场', '实验林场', '林业场',
                  ...
                  '农业试验场', '综合试验场', '果树试验场', '良种试验场', '种苗试验场', '育苗试验场', '林草试验场'}},
    ...
    '水库': {'.': {types.NM, types.irrigation}, '-': {},
           '+': {'水站', '翻水站', '扬水站', '供水站', '水利站', "水务站", '抽水站', '电排站'}},
    ...
    '国营': {'.': {types.NF, types.com}, '-': {},
           '+': {'中交', '中建', '国网', '国电', '中烟', '中电', '中电建', '中铁建', '国家税务总局', '华能', '华电', '华润', '中铁', '国有', '兵团', '中粮', '生产建设兵团'}},
    ...
    '地区': {'.': {types.NS3}, '-': {},
           '+': {'新建区', '新区', '托管区', '保护区', '经开区', '管区', '保护开发区', '保税区', '边境经济合作区', '产业集聚区', '经发区',
                 ...
                 '商贸物流枢纽区', '投资区', }},
    '景区': {'.': {types.NS3, types.NM, types.cultural}, '-': {},
    ...
    '园区': {'.': {types.NS4, types.NM, types.service, types.industry}, '-': {},
           '+': {'采区', '产业园区', '城市工业园区', '发展园区', '服务区', '高教园区', '高科技园区', '高科园区', '高新技术产业园区', '高新技术示范园区', '工业园区', '工业园小区', '广场', '农高区', '科创区', '高科园',
                 '国家农业园区', '化工园区', '教区', '教育园区', '经济工业园区', '酒业园区', '科工贸园区', '科技园区', '空港物流园区', '临港化工园区', '临港物流园区', '牧业园区', '农业高新技术园区', '警备区', '新片区',
                 '农业科技园区', '农业园区', '汽车园区', '商务产业园区', '深加工园区', '生态工业园区', '示范小区', '停车区', '微电子小区', '温泉休闲商务产业园区', '物流园区', '物业区', '现代农业园区', '空港区', '功能区',
                 '校区', '主校区', '二校区', '东校区', '南校区', '西校区', '北校区', '新产业园区', '新技术产业园区', '新型工业园区', '循环经济产业园区', '院区', '中心商务区', '科技商务区', '专利技术园区', '工业园管理区',
                 '制造工业园区', '承接产业转移集中示范园区', '集中示范园区', '现代产业园区', '生态农业园区', '现代服务业园区', '农副产品加工交易园区', '交易园区', '农业园区', '商务商贸街区', '现代农牧业园区', '农牧业园区',
                 '生物科技产业园区', '农机产业园区', '装备制造产业园区', '现代农业产业园区', '农业产业园区', '家纺产业园区', '现代农业示范园区', '农业示范园区', '能源化工园区', '厂区', '国家农业科技园区', '港区', '病区',
                 '轻工业园区', '新材料园区', '高新产业园区', '职业教育园区', '循环经济园区', '循环园区', '安置区', '临空综合经济园区', '新兴产业工业园区', '工业示范区', '生态经济园区', '出口创汇示范园区', '储粮区',
                 '乐器工业园社区', '港务区', '国际港务区', '实验区', '作业区', '加工区', '国际物流加工区', '工业加工区', '出口加工区', '外向型工业加工区', '销售片区', '零售片区', '营销片区', '管理区', '特别管理区',
                 '特别行政管理区', '农垦管理区', '华侨管理区', '经济管理区', '片区', '其他片区', '引灌区', '灌区', '垦区', '围垦区', '库区', '洪泛区', '水库灌区', '资源区', '管护区', '林区', '航空港区', '保税港区', '核心港区'}},
    '产业园': {'.': {types.NS4, types.NM, types.industry, types.service}, '-': {},
            '+': {'科技产业园', '创业园', '工业园', '软件园', '科技园', '创新园', '示范园', '物流园', '发展园', '绿色产业园', '冶金工业园', '科学园', '北区园', '南区园', '科学工业园', '汽车产业园', '科技创新园',
                  '电子商务产业园', '低碳经济园', '高新产业园', '高新技术产业园', '硅工业园', '农业示范园', '矿化工业园', '煤化工业园', '临空综合经济园', '新兴产业工业园', '高科技园', '创意园', '加速园'}},
    '社区': {'.': {types.NS5, types.NM, types.gov}, '-': {},
           '+': {'街道', '集体资产社区', '组团虚拟社区', '直属社区', '直属虚拟社区', '虚拟社区', '虚拟生活区', '生活区', '类似社区', '联合小区', '产业社区', '工业社区', '社区工作站', '类似乡级单位', '特殊社区',
                 '直辖村级区划', '住宅区', '新型农村社区', '中心社区', '中心街道', '虚拟劳管所', '类似村', '公司村', '区块社区', '社区村', '城市社区', '文化社区', '居民区', '小区', '火车站社区'}},
    '公园': {'.': {types.NS5, types.NM, types.cultural}, '-': {},
           '+': {'乐园', '游乐园', '游乐场', '游乐城', '音乐城', '森林公园', '动物园', '风景园', '娱乐湾', '赛马场', '骝马场', '走马场', '溜冰城', '旱冰城', '文化城', '动漫城'}},
