...
class types(Enum):
    ...
    NS1 = 111  # 省/自治区/直辖市
    NS2 = 112  # 地级市/州/盟
    NS3 = 113  # 区/县/旗 (地区/开发区/景区)
    NS4 = 114  # 乡镇/街道/苏木 (园区/工业园/度假区)
    NS5 = 115  # 村屯/社区/嘎查/农场/林场/牧场/渔场 (公园/游乐园)
...
nt_tails = {
    ...
    '联合会': {'.': {types.NM, types.org}, '-': {},
            '+': {'商业联合会', '工商业联合会', '残疾人联合会', '妇女联合会', '残联', '妇联', '文联', '社科联', '公会', '联合公会', '同业公会'}},
    '委员会': {'.': {types.NM, types.gov}, '-': {},
            '+': {'工会委员会', '工作委员会', '管理委员会', '常委会', '人大常委会', '管委会', '组委会', '委会', '区委', '县委', '纪委',
                  '工作委', '常务委', '政法委', '管理委', '党委', '卫健委', '发改委', '州委', '工会委', '工委', '建委', '教委', '文化委', '文卫委', '旅发委',
                  '纪工委', '纪检委', '经贸工委', '计生委', '生态管理委员会', '建设管理委员会', '筹委会',
                  }},
    ...
    "鱼场": {'.': {types.NM, types.fishery}, '-': {},
           '+': {'渔塘', '鱼池', '渔港', '养殖基池', '基池', '养鱼池', '鱼池', '养鱼塘', "渔场", '鱼塘', '鱼苗场', '金鱼池', '鱼原种场', '水产渔场', '鱼苗鱼种场', '鱼种场'}},
    ...
    # 地区/方位
    '中央': {'.': {types.NS}, '-': {},
           '+': {'东', '南', '西', '北', '华北', '东北', '华东', '华中', '华南', '西南', '西北', '东部', '中部', '西部', '中南', '北方', '南方', '东南'}},

    # 开发区/地区/园区
    '地区': {'.': {types.NS3}, '-': {},
           '+': {'新建区', '新区', '托管区', '保护区', '经开区', '资源区', '管护区', '管理区', '管区', '灌区', '垦区', '围垦区', '库区', '林区', '保护开发区', '保税港区', '保税区', '边境经济合作区', '产业集聚区', '产业经济开发区', '产业聚集区',
                 ...
                 '国际合作示范区', '国际物流区', '国家高新区', '国家自主创新示范区', '海港经济开发区', '海洋经济开发区', '航空港区', '航空物流区', '高新技术产业示范区',
                 '合作经济开发区', '合作区', '互市贸易区', '华侨管理区', '华侨经济开发区', '华侨经济区', '华侨投资区', '化工集中区', '火炬高技术开发区', '技术经济开发区', '建设区', '经济管理区', '经济合作区',
                 ...
                 '民营区', '农垦管理区', '农业高新区', '农业经济开发区', '农业开发区', '农业综合开发区', '片区', '其他片区', '汽车产业开发区', '商贸经济示范区', '商贸示范区', '商务区', '新兴技术开发区', '合作产业开发区',
                 '生态经济开发区', '示范区', '水库灌区', '特别管理区', '特别行政管理区', '特别合作区', '特区', '特色农业经济开发区', '外商投资工业区', '高技术产业开发区', '外向型农业开发区',
                 '稀土高新区', '现代产业区', '现代农业产业示范区', '高新技术开发区', '新技术开发区', '新建工业区', '循环工业发展区', '循环经济开发区', '沿海经济开发区', '生态综合开发区', '先进制造业开发区',
                 '沿海经济开发试验区', '移民区', '引灌区', '渔业管区', '中心城区', '城区', '中心区', '转型综合改革示范区', '资源区', '自贸区', '自贸试验区', '自主创新示范区', '综合保税区', '综合经济开发区',
    ...
    '园区': {'.': {types.NS4, types.NM, types.service, types.industry}, '-': {},
           '+': {'北区', '中区', '采区', '产业园区', '城市工业园区', '东区', '发展园区', '服务区', '高教园区', '高科技园区', '高科园区', '高新技术产业园区', '高新技术示范园区', '工业园区', '工业园小区',
                 '国家农业园区', '化工园区', '教区', '教育园区', '经济工业园区', '酒业园区', '科工贸园区', '科技园区', '空港物流园区', '临港化工园区', '临港物流园区', '牧业园区', '南区', '农业高新技术园区',
                 '农业科技园区', '农业园区', '汽车园区', '商务产业园区', '深加工园区', '生态工业园区', '示范小区', '停车区', '微电子小区', '温泉休闲商务产业园区', '物流园区', '物业区', '西区', '现代农业园区',
    ...
    '社区': {'.': {types.NS5, types.NM, types.gov}, '-': {},
           '+': {'街道', '集体资产社区', '组团虚拟社区', '直属社区', '直属虚拟社区', '虚拟社区', '虚拟生活区', '生活区', '类似社区', '联合小区', '产业社区', '工业社区', '社区工作站', '类似乡级单位', '特殊社区',
                 '直辖村级区划', '住宅区', '新型农村社区', '中心社区', '中心街道', '虚拟劳管所', '类似村', '公司村', '区块社区', '社区村', '城市社区', '文化社区', '居民区', }},
    '公园': {'.': {types.NS5, types.NM, types.cultural}, '-': {},
           '+': {'乐园', '游乐园', '游乐场', '森林公园', '动物园', '风景园', '娱乐湾', '赛马场', '骝马场', '走马场'}},

    # 高频单字尾缀
    '厂': {'.': {types.NO, types.industry}, '-': {'厂房', '厂长', '厂内', '厂外', '间距', '间隔', '我厂'}, '+': {}},
    '城': {'.': {types.NO}, '-': {'城墙', '城门'}, '+': {}},
    '部': {'.': {types.NO}, '-': {'部门', '部长', '部分', '我部'}, '+': {}},
    '馆': {'.': {types.NO, types.service}, '-': {'馆长', '本馆', '我馆'}, '+': {}},
