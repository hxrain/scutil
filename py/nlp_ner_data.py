...
nt_tails = {
    ...
    '商店': {'.': {types.NM, types.retail}, '-': {'店内', '门市内', '市面'},
           '+': {'门店', '专门店', '专营店', '专业店', '小店', '精品店', '用品店', '日用品店', '产品店', '便利店', '加盟店', '旗舰店', '总店', '销售店', "代理店", "专属代理店",
                 ...
                 "美妆店", "孕婴店", "装修店", "保健店", "工具店", "洁具店", "皮具店", "杂品店", "阳光店", "布店", "婚庆店", "推拿店", "涂料店", "水暖店", "烟杂店", "耗材店",
    ...
    '万达店': {'.': {types.NM, types.retail}, '-': {},
            '+': {'火车站超市', '超市店', '中心店', '中心文具店', '中学店', "小学店", "小区店", "国际店", '名店', '站店', '堂店', '院店', '苑店', '园店', '新店', '支店', '阁店',
                  '轩店', '斋店', '商贸区店', '少年宫园', '少年宫店', '市政府园', '豪宅店', '华润店', '华能店', '中铁店', '中建店'}},
    ...
    '管理区': {'.': {types.NS3, types.NM, types.cultural}, '-': {},
            '+': {'特别管理区', '风景名胜管理区', '旅游管理区', '生态管理区', '特别行政管理区', '农垦管理区', '华侨管理区', '经济管理区', '垦区', '围垦区', '资源区', '管护区', '林区',
                  '航空港区', '保税港区', '核心港区', '灌区', '销售片区', '旅游区', '文化旅游区', '海湾旅游区', '生态文化旅游区', '风景旅游区', '生态旅游区', '边贸旅游区', }},
