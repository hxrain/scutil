...
class types:
    ...
    # NT组份类别优先级
    NA = ('NA', 132)  # 弱化的特殊名称(地名中含有NO单字尾缀的名称)
    NO = ('NO', 133)  # 组织机构的单字尾缀
    NN = ('NN', 134)  # 企业名称字号

    NS = ('NS', 140)  # 地区类型
    NS1 = ('NS1', 141)  # 省/自治区/直辖市
    NS2 = ('NS2', 142)  # 地级市/州/盟
    NS3 = ('NS3', 143)  # 区/县/旗 (地区/开发区/景区)
    NS4 = ('NS4', 144)  # 乡镇/街道/苏木 (园区/工业园/度假区)
    NS5 = ('NS5', 145)  # 村屯/社区/嘎查/农场/林场/牧场/渔场 (公园/游乐园)
    ...
    def _init_():
        ...
        types._maps = {
            ...
            types.NM[1]: types.NM, types.NB[1]: types.NB, types.NL[1]: types.NL, types.NH[1]: types.NH,
        }
    ...
    def joint(v, t):
        ...
        def make_set(val):
            rst = set()
            if val in types._itms and val[1] < types.NX[1]:
                rst.add(types.type(val))
            else:
                for v in val:
                    if v not in types._itms or v[1] < types.NX[1]:
                        continue
...
nt_tails = {
    ...
    '国营': {'.': {types.NF, types.com}, '-': {},
           '+': {'中交', '中建', '国网', '国电', '中烟', '中电', '中电建', '中铁建', '国家', '华能', '华电', '中铁', '兵团', '中粮', '生产建设兵团', '中城建', '中电信', '中国网通'}},
    ...
    '大街': {'.': {types.NA}, '-': {},
           '+': {'东', '南', '西', '北', '省', '市', '区', '县', '州', '盟', '旗', '乡', '村', '镇', '屯', '路', '街', '巷', '河', '道', '大道', '线', '段', '跨', '左', '右', '新', '旧', '老', '原', '含',
                 '驻', '女', '至', '暨', '和', '及', '与', '内', '外', '上', '下', '案', '报', '旁', '的', '/', '.', '-', 'A', 'B', 'C', 'D', 'E',
                 }},

    # 开发区/地区/园区
    '地区': {'.': {types.NS3}, '-': {},
           '+': {'开发区', '新区', '托管区', '保护区', '经开区', '管区', '保护开发区', '保税区', '边境经济合作区', '产业集聚区', '经发区',
    ...
    '片区': {'.': {types.NS4, types.medical}, '-': {},
           '+': {'疗区', '监区', '矿区', '新片区', '病区', '居民区', '小区', '住宅区', '分蓄洪区', '蓄洪区', '洪泛区', '园区'}},
    ...
    '科技园区': {'.': {types.NS4, types.NM, types.service, types.industry}, '-': {},
             '+': {'采区', '城市工业园区', '发展园区', '高教园区', '高科技园区', '高科园区', '高新技术产业园区', '工业园区', '工业园小区', '农高区', '科创区',
                   '国家农业园区', '化工园区', '教育园区', '经济工业园区', '酒业园区', '科工贸园区', '空港物流园区', '临港化工园区', '临港物流园区', '牧业园区', '农业高新技术园区', '警备区', '高新园区',
                   ...
                   '新产业园区', '新技术产业园区', '新型工业园区', '循环经济产业园区', '制造工业园区', '现代产业园区', '生态农业园区', '现代服务业园区', '农副产品加工交易园区', '交易园区', '农业园区', '实验园区',
                   '商务商贸街区', '现代农牧业园区', '农牧业园区', '生物科技产业园区', '农机产业园区', '装备制造产业园区', '现代农业产业园区', '农业产业园区', '家纺产业园区', '能源化工园区', '厂区', '育种园区',
                   '国家农业科技园区', '港区', '轻工业园区', '新材料园区', '高新产业园区', '职业教育园区', '循环经济园区', '循环园区', '安置区', '临空综合经济园区', '新兴产业工业园区', '工业示范区', '生态经济园区', '储粮区',
                   '港务区', '国际港务区', '实验区', '作业区', '加工区', '国际物流加工区', '工业加工区', '出口加工区', '外向型工业加工区', '科创园区', '示范园区', '福利园区', '服务园区', '中心园区'}},
