...
nt_tails = {
    ...
    '工厂': {'.': types.tags_NM, '-': {},
           '+': {'加工厂', '化工厂', '净水厂', '纯水厂', '电线厂', '配件厂', '建材厂', '修理厂', '汽修厂', '维修厂', '开关厂', '家具厂', "服饰厂", "冶选厂", "分选厂", "生产厂", "机修厂", "冷冻厂", "雕刻厂",
                 '工具厂', '模具厂', '玩具厂', '预制厂', '印刷厂', '彩印厂', '制品厂', '用品厂', '艺品厂', '食品厂', '仪器厂', '电器厂', '设备厂', '塑料厂', '材料厂', "标牌厂", "玻璃厂", "选矿厂", "再选厂",
                 '涂料厂', '石料厂', '机械厂', '水泥厂', '处理厂', '门窗厂', '电缆厂', '工艺厂', '制衣厂', '包装厂', '服装厂', '修造厂', '制造厂', '铸造厂', '修配厂', '五金厂', "实验厂", '选煤厂', '采油厂',
    ...
    '公司': {'.': types.tags_NM, '-': {},
           '+': {'总公司', '有限公司', '有限责任公司', '责任公司', '股份公司', '集团公司', '集团有限公司', '集团有限责任公司', '集团总公司', '株式会社', '连锁有限公司', '大药房有限公司',
                 ...
                 '旅行社有限公司', '设计院有限公司', '研究院有限公司', '医院有限公司', '服务区有限公司', '两合公司', '银行股份有限公司', '有限总公司', '总部'}},
    '中心': {'.': types.tags_NM, '-': {},
    ...
    '商店': {'.': types.tags_NM, '-': {'店内', '门市内', '市面'},
           '+': {'专门店', '专营店', '专业店', '精品店', '用品店', '日用品店', '产品店', '便利店', '加盟店', '旗舰店', '总店', '销售店', "代理店", "专属代理店", '平价综合商店',
                 ...
                 '小超市', '便民超市', '生活超市', '百货超市', '烟酒超市', '连锁超市', '通讯店', '农资店', '电脑店', "收购店", "代销店", "分销店", "直销店", "门业店",
                 '便民店', '器材店', '建材店', '眼镜店', '装饰店', '手机店', '材料店', '科技店', '电器店', '加工店', '食品超市', '水果超市', '总代理',
                 '维修店', '配件店', '文具店', '玩具店', '服务店', '广告店', '饰品店', '批零部', '门窗店', '内衣店', '女装店', '童装店', '服饰店',
                 "网店", "体验店", "小卖铺", "补胎店", "花艺店", "制衣店", "寿衣店", "电讯店", "租赁店", "电动车店", "不锈钢店", "首饰店", "护肤品店", "玉器店", "花圈店",
                 "美妆店", "孕婴店", "装修店", "保健店", "工具店", "洁具店", "皮具店", "杂品店", "阳光店", "婚庆店", "推拿店", "涂料店", "水暖店", "烟杂店", "耗材店",
                 "钢材店", "水泥店", "卫浴店", "煤店", "宠物店", "理疗店", "瓷砖店", "护肤店", '傢俬店', '家俬店', '仓储店', '中心门店', '专档', '经营坊', '形象店', '普通店', }},
    '坊店': {'.': types.tags_NO, '-': {},
           '+': {'金店', '花店', '包店', '锁店', "花坊", '货店', "布店", '之家', '花舍', '衣舍', '鞋店', '门市', '名店', '新店', '支店', '阁店', '书店', '鞋荘', "商社", '中心店',
                 "道馆", '书屋', '艺品店', '生活馆', '沙龙', '五金店', "家电店", '门店', '花苑', "表店", }},
    # 地标店铺
    '万达店': {'.': types.tags_NO, '-': {},
    ...
    '中华人民共和国': {'.': types.tags_NF, '-': {},
                '+': {'中国共产党', '共产党', '中国共青团', '共青团', '中国人民解放军', '中国人民武装警察部队', '中国人民武警部队', '中国人民政治协商会议'}},
    ...
    '与': {'.': types.tags_NA, '-': {},
          '+': {'县城', '东部', '中部', '西部', '南部', '北部', '以东', '以西', '以南', '以北', '东西', '南北', '西南', '西北', '中南', '东南', '/', '·', '.', '-', '、', '&',
