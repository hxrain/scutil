...
nt_tails = {
    ...
    '公司': {'.': {types.NM, types.com}, '-': {},
           '+': {'总公司', '有限公司', '有限责任公司', '责任公司', '股份公司', '集团公司', '集团有限公司', '集团有限责任公司', '集团总公司', '株式会社', '顾问有限公司', '连锁有限公司',
                 ...
                 '建设发展有限公司', '设计有限公司', '建设有限公司', '制造有限公司', 'LTD', '劳司', '工司', '有限责任工司', '农工商联合公司', '农工商公司', '农工商总公司', '酒店管理有限公司',
    ...
    '学校': {'.': {types.NM, types.edu}, '-': {'学业'},
           '+': {'小学', '小学校', '中学', '中学校', '高中', '中心校', '总校', '中心学校', '武校', '盲校', '网校', '聋校', '联校', '公学', '职业中学', '附属中学', '中心小学校', '中心中学',
                 ...
                 '校区', '二校区', '东校区', '南校区', '西校区', '北校区', '中心校区', '学区', '基地校', '初中部', '高中部', '初中校', '高中校', '小学东校', '小学西校', '小学南校', '小学北校',
    ...
    '茶馆': {'.': {types.NM, types.catering}, '-': {},
           '+': {'茶社', '茶庐', '茶楼', '茶舍', '茶座', '茶都', '茶莊', '茶艺居', '茶艺店', '茶艺苑', '茶饮店', '茶饮坊', '茶叶店', '茶居', '茶荘', '茶庄', '茶庄行', '茗茶轩', '茶轩', '茶饮室', '茶艺坊', '茶艺室',
    ...
    '商店': {'.': {types.NM, types.retail}, '-': {'店内', '市内', '市面'},
           '+': {'门店', '专门店', '专营店', '专业店', '小店', '精品店', '用品店', '日用品店', '产品店', '便利店', '加盟店', '旗舰店', '总店', '销售店', "代理店", "专属代理店",
                 ...
                 "家电店", "理疗店", "瓷砖店", "护肤店", '傢俬店', '家俬店', '仓储店', '中心门店', '专档', '经营坊', '形象店', '普通店'}},
    ...
    '园区': {'.': {types.NS4, types.NM, types.service, types.industry}, '-': {},
           '+': {'采区', '城市工业园区', '发展园区', '高教园区', '高科技园区', '高科园区', '高新技术产业园区', '工业园区', '工业园小区', '农高区', '科创区',
                 ...
                 '港务区', '国际港务区', '实验区', '作业区', '加工区', '国际物流加工区', '工业加工区', '出口加工区', '外向型工业加工区', '管理区', '特别管理区',
