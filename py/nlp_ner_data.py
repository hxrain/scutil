...
nt_tails = {
    # 工矿企业
    '分店': {'.': {types.NB}, '-': {},
           '+': {'分号', '分厂', '分矿', '分校', '分公司', '子公司', '分工厂', '分司', '分工司', '支公司', '分部', '分局', '分院', '分所', '直属分局', '支局', '分园', '子厂', '分场', '分社',
                 '分站', "分会", "子站", "分队", "分处", '分台', '(分)局', '名胜区分公司', '机场分公司', '林场分公司', '牧场分公司', '火车站分公司', '火车站分社',
    ...
    '公司': {'.': {types.NM, types.com}, '-': {},
           '+': {'总公司', '有限公司', '有限责任公司', '责任公司', '股份公司', '集团公司', '集团有限公司', '集团有限责任公司', '集团总公司', '株式会社', '连锁有限公司',
                 '服务公司', '工程公司', '股份有限公司', 'LTD', '劳司', '有限责任工司', '农工商联合公司', '农工商公司', '农工商总公司', '酒店管理有限公司',
    ...
    '合作社': {'.': {types.NM, types.industry, types.farming}, '-': {},
            '+': {'合社', '综合社', '联合社', '经济联合社', '合作社联合社', '专业合作社联合社', '供销合作社联合社', '合作社联社',
    ...
    # 前导冠字
    '中华人民共和国': {'.': {types.NF, types.gov}, '-': {},
                '+': {'中国共产党', '共产党', '共青团', '生产建设兵团', '中城建', '中电信', '中国网通', '中电建', '中铁建', }},
    ...
    '片区': {'.': {types.NS4, types.medical}, '-': {},
           '+': {'疗区', '监区', '矿区', '坝区', '煤区', '新片区', '示范片', '病区', '居民区', '小区', '住宅区', '分蓄洪区', '蓄洪区', '洪泛区', '园区', '分区', }},
    ...
    '科技园区': {'.': {types.NM, types.service, types.industry}, '-': {},
