...
nt_tails = {
    ...
    '大街': {'.': {types.NA}, '-': {},
           '+': {'东', '南', '西', '北', '省', '市', '区', '县', '州', '盟', '旗', '乡', '村', '镇', '屯', '路', '街', '巷', '道', '大道', '线', '段', '跨', '左', '右', '新', '旧', '老', '原', '含',
                 '驻', '女', '至', '暨', '和', '及', '与', '内', '外', '上', '下', '案', '报', '旁', '/', '.', '-','A','B','C','D','E',
                 }},
    ...
    '科技园区': {'.': {types.NS4, types.NM, types.service, types.industry}, '-': {},
             '+': {'采区', '城市工业园区', '发展园区', '高教园区', '高科技园区', '高科园区', '高新技术产业园区', '工业园区', '工业园小区', '农高区', '科创区',
                   '国家农业园区', '化工园区', '教育园区', '经济工业园区', '酒业园区', '科工贸园区', '空港物流园区', '临港化工园区', '临港物流园区', '牧业园区', '农业高新技术园区', '警备区',
