...
def make_static_sysinfo():
    try:
        ...
        log.error("make_static_sysinfo.ERR:%s:%s", e.__class__, e)
        return None
    except BaseException as e:
        log.error("make_static_sysinfo.E:%s:%s", e.__class__, e)
        return None
...
def make_realtime_sysinfo():
    try:
        ...
        log.error("make_realtime_sysinfo.E:%s:%s", e.__class__, e)
        return None
...
def make_realtime_psinfo(pid):
    try:
        ...
        if hasattr(ti, 'children_user') and hasattr(ti, 'children_system'):
        ...
        log.error("make_realtime_psinfo.E:%s:%s", e.__class__, e)
        return None
